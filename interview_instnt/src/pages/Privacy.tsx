...
const Privacy: React.FC = () => {
  ...
  const [privacyOption, setPrivacyOption] = useState<'none' | 'link' | 'text'>('none');
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-6 md:p-8 space-y-6">
            ...
            <p className="text-gray-600 text-sm">
              Make your recruitment privacy policy available to your job candidates prior to them starting their application. You can set this now or later from your profile page.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                />
                <Label htmlFor="none" className="font-normal text-gray-900 cursor-pointer">None</Label>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    className="h-5 w-5 text-primary border-gray-300 focus:ring-primary"
                  />
                  <Label htmlFor="link" className="font-normal text-gray-900 cursor-pointer">Link to web page</Label>
                </div>
                {privacyOption === 'link' && (
                  <div className="pl-8">
                    <Input 
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    className="h-5 w-5 text-primary border-gray-300 focus:ring-primary"
                  />
                  <Label htmlFor="text" className="font-normal text-gray-900 cursor-pointer">Policy text</Label>
                </div>
                {privacyOption === 'text' && (
                  <div className="pl-8">
                    <Textarea 
