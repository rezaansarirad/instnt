...
const CreateJob: React.FC = () => {
  ...
  const confirmDelete = () => {
    if (itemToDelete) {
      if (itemToDelete.type === "requirement") {
        setRequirements(
          requirements.filter((req) => req.id !== itemToDelete.id),
        );
  ...
  const handleRequirementAdd = () => {
    if (newRequirement.trim()) {
      setRequirements([
        ...requirements,
        { id: Date.now(), title: newRequirement },
      ]);
      setNewRequirement("");
    }
  };
    ...
    <div className="min-h-screen bg-white bg-dot-pattern">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        {currentStep === 1 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 items-start md:items-center">
              <Label className="md:col-span-3 text-gray-600 font-normal text-base">
                Job title (required)
              </Label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 items-start">
              <Label className="md:col-span-3 text-gray-600 font-normal text-base pt-2">
                Job description
              </Label>
              <div className="md:col-span-9">
                <Textarea
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 items-start md:items-center">
              ...
              <div className="md:col-span-9 flex items-center gap-2">
                <Switch
                  ...
                  onCheckedChange={(c) => setValue("cvRequired", c)}
                />
              </div>
            </div>
        ...
        {currentStep === 2 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <p className="text-gray-600 mb-6">
              Are there requirements your candidates absolutely need to have in
              order to qualify for this job? Candidates that do not confirm
              these requirements cannot apply.
            </p>
            ...
            <div className="bg-gray-50 rounded-lg p-4 md:p-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6">
                ...
                <Button
                  ...
                  className="bg-primary/80 hover:bg-primary text-white whitespace-nowrap w-full sm:w-auto"
                >
                  Add requirement
                </Button>
              </div>
        ...
        {currentStep === 3 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <p className="text-gray-600 mb-6">
              Add up to 10 questions. For each, decide the number of attempts
        ...
        {currentStep === 4 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <p className="text-gray-600 mb-6">
              Add a short video to introduce this job to your candidates and get
              a better idea about the position, the team and the company. Adding
              an intro video generally makes candidates feel more comfortable
              about doing video interviews.
            </p>
